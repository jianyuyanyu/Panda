...
HRESULT Panda::D2DGraphicsManager::CreateGraphicsResources()
{
    HRESULT hr = S_OK;
...
int  Panda::D2DGraphicsManager::Initialize()
{
    int result = 0;
...
void Panda::D2DGraphicsManager::Tick()
{
}

void Panda::D2DGraphicsManager::Finalize()
{
