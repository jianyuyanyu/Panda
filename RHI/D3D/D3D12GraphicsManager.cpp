...
HRESULT Panda::D3D12GraphicsManager::CreateDescriptorHeaps()
{
    HRESULT hr;
    ...
    cbvSrvUavHeapDesc.NumDescriptors = 
        k_FrameCount +      // FrameCount cbvs
        100;                // 100 for srv(texture)
...
HRESULT Panda::D3D12GraphicsManager::CreateDepthStencil()
{
    HRESULT hr;
...
HRESULT Panda::D3D12GraphicsManager::CreateVertexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT Panda::D3D12GraphicsManager::CreateIndexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT Panda::D3D12GraphicsManager::CreateTextureBuffer(const Image& image)
{
    HRESULT hr;
